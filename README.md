...
当前稳定版为 [v1.1.16](https://github.com/NaNA1337/super-proxy/releases/tag/v1.1.16)，已实测 VPN Gate 获取、三出口、Reality HTTPS、手动切换以及 [Super-Proxy Manager](https://github.com/NaNA1337/super-proxy-manager) 联动。
